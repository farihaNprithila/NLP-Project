...
# Pre processing the train and validation set for pre-trained BERT model so that att the tokenization
...
predictor.save('/Users/Prithila/Desktop/Project NLP/berttwitter')
